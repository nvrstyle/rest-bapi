...
INSERT INTO User (id, office_id, country_id, first_name, second_name, middle_name, position, phone, is_identified) VALUES
(1, 1, 1, 'Артем', 'Андреев', 'Петрович', 'Генеральный директор', '+7 917 345 12 11', true),
(2, 1, 1, 'Снежана', 'Семенова', 'Денисовна', 'Заведующая хозяйством', '+7 987 100 01 11', true),
(3, 2, 1, 'Владислав', 'Архипов', 'Владимирович', 'Водитель-экспедитор', '+7 909 350 88 78', true),
(4, 2, 2, 'Сергей', 'Семенов', 'Браниславович', 'Продавец', '+7 911 123 45 67', true),
(5, 3, 1, 'Остап', 'Ибрагимович', 'Владимирович', 'Начальник отдела продаж', '+7 905 905 43 34', true),
(6, 3, 3, 'Андрей', 'Ильин', 'Сергеевич', 'Кладовщик', '+7 913 139 13 13', true),
(7, 4, 1, 'Максим', 'Иванов', 'Николаевич', 'Грузчик', '+7 987 595 13 13', true),
(8, 4, 2, 'Игорь', 'Комиссаров', 'Олегович', 'Программист 1С', '+7 989 567 76 43', true),
(9, 5, 1, 'Иван', 'Петров', 'Ильдарович', 'Маркетолог', '+7 935 567 76 43', true),
(10,5, 1, 'Альберт', 'Васичкин', 'Мальбертович', 'Каменщик', '+7 927 000 77 43', true),
(11,3, 3, 'Игнат', 'Пупкин', 'Геннадьевич', 'Логист', '+7 927 001 37 43', true),
(12,3, 1, 'Константин', 'Пчелкин', 'Андреевич', 'Клиентский менеджер', '+7 917 101 32 49', true);

INSERT INTO Doc (user_id, type_id, number, date) VALUES
